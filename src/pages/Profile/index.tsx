...
const Profile: React.FC = () => {
  ...
  if (!user) {
    return <div className="p-6"><AlertBox type="error" description={t('pages.profile.noUserInfo')} /></div>
  }
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <SectionCard>
        ...
        {/* 消息提示 */}
        {error && <div className="mt-4"><AlertBox type="error" description={error} /></div>}
        {success && <div className="mt-4"><AlertBox type="success" description={success} /></div>}
